...
export default function AIChatWidget() {
  ...
  const chatT = {
    en: {
      ...
      welcome: "Hello! I am CraftVanta's AI Growth Partner. Tell me about your business (e.g., 'I run a retail shop' or 'I am a doctor') or ask about our bespoke web systems and AI automation services.",
      whatsappCta: "Direct WhatsApp",
      bookCta: "Book Live Slot",
      emailCta: "Email RFPs/Docs",
      errorMsg: "Connection error. Please try again, or contact CraftVanta directly on WhatsApp.",
      suggestedTitle: "Select your business type:",
      typingIndicator: "CraftVanta's Assistant is typing...",
      chips: [
